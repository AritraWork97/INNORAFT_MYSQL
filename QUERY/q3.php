...
$sql_empdetails = "SELECT employee_code_table.employee_code_name FROM employee_code_table WHERE employee_code_table.employee_code IN 
                    (SELECT employee_salary_table.employee_code FROM employee_salary_table WHERE employee_salary_table.employee_id IN 
                    (SELECT employee_details_table.employee_id FROM `employee_details_table` WHERE employee_details_table.graduation_percentile < 70))";
